...
above:
	...
	cout << "\t\t\t\t\t\t\t\tNumber     Flight Name        Departure       Destination" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<1>        in001              Chennai          Mumbai" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<2>        in001              Mumbai         Chennai" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<3>        in002              Chennai          Delhi" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t<4>        in003              Delhi         Chennai" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\t----------------------------------------------------------" << endl
		 << endl;
	cout << "\t\t\t\t\t\t\t\tPress any key to continue...";
